...
def add_optimization_args(parser):
    ...
    group.add_argument('--assistant', action='store_true',
                       help='whether use assistant as batch sampler')
    group.add_argument('--batch_method', type=str, default='sentences',
                       help='the method to distribute instances [sentences, bins]')
    group.add_argument('--use-tfidf', action='store_true',
                       help='whether use tf-idf version of assistant')
    group.add_argument('--spl', action='store_true',
                       help='whether use spl')
